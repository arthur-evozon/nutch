...
public class Extension {
	 ...
	 * @param pExtensionPoint an extension porin
	...
	public String toString() {
		return "Extension{" + "fId='" + fId + '\'' + ", fTargetPoint='" + fTargetPoint + '\'' + ", fClazz='" + StringUtils.substring(fClazz, fClazz
                .lastIndexOf('.') + 1) + '\'' + ", " + "fAttributes=" + fAttributes + '}';
	}
}
