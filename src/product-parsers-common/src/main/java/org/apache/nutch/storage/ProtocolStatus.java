...
public class ProtocolStatus extends
  ...
  public void put(int field$, Object value) {
    ...
    case 0:
      ...
      break;
    case 1:
      args = (java.util.List<CharSequence>) ((value instanceof org.apache.gora.persistency.Dirtyable) ? value
  ...
  public static class Builder extends
    ...
    private Builder(ProtocolStatus other) {
      ...
      if (isValidValue(fields()[0], other.code)) {
        this.code = (Integer) data().deepCopy(fields()[0].schema(),
            other.code);
        fieldSetFlags()[0] = true;
      }
      if (isValidValue(fields()[1], other.args)) {
        this.args = (java.util.List<CharSequence>) data().deepCopy(
            fields()[1].schema(), other.args);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.lastModified)) {
        this.lastModified = (Long) data().deepCopy(
    ...
    public Builder setArgs(
        java.util.List<CharSequence> value) {
    ...
    public ProtocolStatus build() {
      try {
        ...
        record.code = fieldSetFlags()[0] ? this.code
            : (Integer) defaultValue(fields()[0]);
        record.args = fieldSetFlags()[1] ? this.args
            : (java.util.List<CharSequence>) new org.apache.gora.persistency.impl.DirtyListWrapper(
